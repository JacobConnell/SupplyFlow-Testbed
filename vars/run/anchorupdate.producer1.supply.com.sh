...
jq '.channel_group.groups.Application.groups."producer1-supply-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer1.producer1.supply.com","port": 7051}]},"version": "0"}}' supplychain_current_config.json > supplychain_modified_anchor_config.json
